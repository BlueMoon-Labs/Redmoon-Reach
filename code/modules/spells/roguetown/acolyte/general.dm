		...
		switch(user.patron.type)
			...
			if(/datum/patron/divine/xylix)
				...
				switch(situational_bonus)
					if(1)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll1", 15, MUTATIONS_LAYER, soundin = 'sound/misc/psydong.ogg', y_offset = 32)
						user.psydo_nyte()
					...
					if(2)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll2", 15, MUTATIONS_LAYER, soundin = 'sound/magic/mockery.ogg', y_offset = 32)
						user.psydo_nyte()
						...
						GLOB.scarlet_round_stats[STATS_PEOPLE_SMITTEN]++
						to_chat(user, span_danger("Ксайликс смеётся над вами!"))
					if(3)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll3", 15, MUTATIONS_LAYER, soundin = 'sound/magic/xylix_1.ogg', y_offset = 32)
					if(4)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll4", 15, MUTATIONS_LAYER, soundin = 'sound/magic/xylix_2.ogg', y_offset = 32)
					if(5)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll5", 15, MUTATIONS_LAYER, soundin = 'sound/magic/xylix_3.ogg', y_offset = 32)
					if(6)
						user.play_overhead_indicator('icons/mob/overhead_effects.dmi', "roll6", 15, MUTATIONS_LAYER, soundin = 'sound/magic/xylix_4.ogg', y_offset = 32)

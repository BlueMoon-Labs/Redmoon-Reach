...
/obj/structure/ascendant_altar/proc/ascend(mob/living/user)
	...
	switch(ascend_stage)
		if(1)
			...
			priority_announce("Лей-линии начинают дрожать в неестественном извращении - СТАРШИЙ АРКАН: ШУТ, ПРЯМОЕ ПОЛОЖЕНИЕ.", "МЕЧТАТЕЛЬ", 'sound/villain/dreamer_warning.ogg')
		if(2)
			...
			priority_announce("Небо начинает вращаться быстрее - СТАРШИЙ АРКАН: ПОВЕСЁЛЁННЫЙ, ПЕРЕВЕРНУТОЕ ПОЛОЖЕНИЕ.", "МЕЧТАТЕЛЬ ", 'sound/villain/dreamer_warning.ogg')
		if(3)
...
/obj/structure/ascendant_altar/proc/heavensaysdanger()
	priority_announce("МЕЧТАТЕЛЬ ВОЗНЕССЯ - СТАРШИЙ АРКАН: T$yh3 TOW##ER, RE v3RSED", "БОГ ГРЯДЁТ!", 'sound/villain/ascendant_intro.ogg')
	sleep(15 SECONDS)

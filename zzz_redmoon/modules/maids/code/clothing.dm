/obj/item/clothing/cloak/apron/waist/maid
	...
	icon = 'zzz_redmoon/modules/maids/icons/maids.dmi'
	mob_overlay_icon = 'zzz_redmoon/modules/maids/icons/onmob/maids_onmob.dmi'
	sleeved = 'zzz_redmoon/modules/maids/icons/onmob/maids_onmob.dmi'
...
/obj/item/clothing/suit/roguetown/shirt/dress/maid
	...
	body_parts_covered = CHEST|LEGS|VITALS
	boobed = TRUE
